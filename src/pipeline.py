...
from src.database.sql_runner import data_quality_gate
...
def main():
 ...
 stage('Generate data',lambda:generate(a.users,a.seed))
 stage('Validate CSV',validate)
 stage('Create and load MySQL',load)
 stage('MySQL data-quality gate',lambda:data_quality_gate(ROOT/'sql/03_data_quality.sql'))
 stage('Execute canonical analytics SQL and export',export)
 stage('Generate figures',figures)
